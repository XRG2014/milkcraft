...
.then(data => {
    ...
    {% else %}
    document.getElementById("serverStatus").innerHTML = `<p class="font-bold select-none">${data.players.online}/20 playing</p>`;
    document.getElementById("serverStatusM").innerHTML = `<p class="font-bold select-none">${data.players.online}/20 playing</p>`;
    {% endif %}
});

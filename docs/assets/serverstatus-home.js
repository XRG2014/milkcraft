...
.then(data => {
    ...
    {% else %}
    var delstat = document.getElementById("serverStatus")
    delstat.parentNode.removeChild(delstat);
    var delstatm = document.getElementById("serverStatusM")
    delstatm.parentNode.removeChild(delstatm);
    {% endif %}
});
